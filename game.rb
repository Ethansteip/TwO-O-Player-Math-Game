class Game
  ...
  def start_game
    ...
    while (@winner == nil) do
      ...
      # Check answer and display appropriate message
      if player_input == answer
        ...
        @user_turn == 1 ? player_1.lose_point : player_2.lose_point
      end
  ...
  # Output score at the end of each round
  def output_score
    #get score state from players class
  end
